...
<style lang="scss">
    ...
    .core-modal-wrap {
        ...
        .core-modal {
            ...
            color: $modal-font-color !important;
            ...
            // min-height: 70vh;//注释掉formModal最小高度
            // min-height: 425px;//注释掉formModal最小高度
            min-height: 210px;//注释掉formModal最小高度
            max-height: 85vh;
            overflow: hidden;
            &-small {
                width: 600px;
            ...
            .core-modal-header {
                ...
                &::after {
                    ...
                    bottom: 0;
                    height: 1px;
                    background: $table-before-line-color;
                }
                h2 {
                    font-size: 14px;
                }
            ...
            .core-modal-body {
                ...
                // border-bottom: 1px solid $table-before-line-color;
                .content-body {
                    padding: 0 24px;
                    position: relative;
                    flex: 1 1 auto;
